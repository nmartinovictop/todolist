...
function showSpecificProject(project) {
    ...
    projectList = _toDoObject_js__WEBPACK_IMPORTED_MODULE_2__.listOfToDos.filter( todo => {
...
function renderTasks(project) {
    ...
    deleteButton.addEventListener('click', () => {
        ...
        let projectIndex = _projects_js__WEBPACK_IMPORTED_MODULE_2__.listOfProjects.findIndex(task => (task.title == project))
        ...
        renderTasks("Inbox")
            localStorage.setItem('listofprojects',JSON.stringify(_projects_js__WEBPACK_IMPORTED_MODULE_2__.listOfProjects))
...
const toDoFactory = (title, description, dueDate, priority, project, isCompleted) => {
    ...
    dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(dueDate),"MM/dd/yyyy")
