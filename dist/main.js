...
function renderTasks(project) {
    ...
    if (project === 'All') {
        tasks =  _toDoObject_js__WEBPACK_IMPORTED_MODULE_4__.listOfToDos
    } else if (project === 'Today') {
        tasks = _toDoObject_js__WEBPACK_IMPORTED_MODULE_4__.listOfToDos.filter(task => {
            let now = new Date()
            let taskDate = new Date(task.dueDate)
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(taskDate)
        })
        ...
        tasks = _toDoObject_js__WEBPACK_IMPORTED_MODULE_4__.listOfToDos.filter(task => {
            ...
            const next_7_days = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(now, {
                days: 7,
              })
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(now,taskDate) < 0 && (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(now,taskDate) > -7


        })
    } else {
        tasks = (0,_projects_js__WEBPACK_IMPORTED_MODULE_2__.showSpecificProject)(project)
    }
